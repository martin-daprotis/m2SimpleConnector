...
var createCustomer_1 = require("../../cart/customer/createCustomer");
...
function createCustomer(_a) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, createCustomer_1.fetchCreateCustomer({
                        firstName: firstName,
                        lastName: lastName,
                        email: email,
                        password: password,
                ...
                case 1:
                    ...
                    data = createCustomer_1.normalizeCreateCustomer(rawData);
